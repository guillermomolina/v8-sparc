...
#ifndef V8_CRANKSHAFT_SPARC_LITHIUM_CODEGEN_SPARC_H_
#define V8_CRANKSHAFT_SPARC_LITHIUM_CODEGEN_SPARC_H_
...
#undef DECLARE_DO
 ...
 private:
  ...
  void DeoptimizeIf(Condition condition, LInstruction* instr,
                    ...
                    Register src1 = kZeroRegister,
                    const Operand& src2 = Operand(kZeroRegister));
  void DeoptimizeIf(
      Condition condition, LInstruction* instr,
      Deoptimizer::DeoptReason deopt_reason = Deoptimizer::kNoReason,
      Register src1 = kZeroRegister, const Operand& src2 = Operand(kZeroRegister));
...
#endif  // V8_CRANKSHAFT_SPARC_LITHIUM_CODEGEN_SPARC_H_
