...
class RegExpMacroAssemblerSPARC : public NativeRegExpMacroAssembler {
 public:
  RegExpMacroAssemblerSPARC(Isolate* isolate, Zone* zone, Mode mode,
                          int registers_to_save);
  virtual ~RegExpMacroAssemblerSPARC();
 ...
 private:
  ...
  // the end of the string.
  inline Register current_input_offset() { return l0; }

  // The register containing the current character after LoadCurrentCharacter.
  inline Register current_character() { return l1; }

  // Register holding address of the end of the input string.
  inline Register end_of_input_address() { return l2; }
  ...
  inline Register backtrack_stackpointer() { return l3; }

  // Register holding pointer to the current code object.
  inline Register code_pointer() { return l4; }
...
/*
  ...
  void BranchOrBacktrack(Condition condition, Label* to, Register cr = g0);

  // Call and return internally in the generated code in a way that
  // is GC-safe (i.e., doesn't leave absolute code addresses on the stack)
  inline void SafeCall(Label* to, Condition cond = allways, Register cr = g0);*/
